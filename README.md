...
- [PHP Notes For Professionals](https://goalkicker.com/PHPBook/)

### Python
- [Python Openclassrooms](https://openclassrooms.com/search?query=python)
...
- [Symfony Books](https://symfony.com/book)

### Django
- [Django Openclassrooms](https://openclassrooms.com/search?query=django)
- [Django official website](https://docs.djangoproject.com/en/4.2/)
